    ...
    <div class="space-y-6">
        <div>
            ...
            <div
                ...
                class="flex items-stretch overflow-hidden rounded-lg border border-border bg-card/85 shadow-sm backdrop-blur-sm"
            >
                <div
                    class="flex w-28 items-center justify-center border-r border-border px-3 py-5"
                >
        ...
        >
            ...
            <div class="space-y-4 px-6 pb-6">
                ...
                >
                    ...
                    <div class="shrink-0">
                        <select
                            v-if="(a.status ?? 'scheduled') === 'scheduled'"
                            ...
                            "
                        >
                            <option disabled value="scheduled">
                                Set status...
                            </option>
